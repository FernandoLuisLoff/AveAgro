 ...
 * @author ferlo
 */
public class EntradaDeLotesListModel  extends AbstractTableModel {
    private List<EntradaLotes> listaEntradaLotes;
    
    private String[] colunas = new String[]{"Código", "Identificador", "Granja", "Quantidade de Frangos", "Valor de Entrada do Lote", "Data da Entrada"};
